                        ...
                        <div class="card-body px-3 py-4">
                            <div class="table-responsive p-0">
                                <form role="form" class="text-start" action="{{ route('producto.update', $producto->ID) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" id="Nombre" name="Nombre" value="{{ $producto->Nombre }}" class="form-control" placeholder="Ingresa el nombre del producto" aria-label="Nombre" aria-describedby="nombre-addon">
                                    </div>

                                    <label for="Precio">Precio:</label>
                                    <div class="mb-3">
                                        <input type="text" id="Precio" name="Precio" value="{{ $producto->Precio }}" class="form-control" placeholder="Ingresa el precio del producto" aria-label="Precio" aria-describedby="precio-addon">
                                    </div>
