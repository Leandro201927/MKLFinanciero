                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    <h3 class="font-weight-black text-dark display-6">Restablecer contraseña</h3>
                                    ...
                                    <form role="form" class="text-start" method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="mb-3">
                                            <input type="email" id="email" name="email" class="form-control"
                                                placeholder="Correo electrónico" value="{{ $email ?? old('email') }}"
                                        ...
                                        <div class="mb-3">
                                            <input type="password" id="password" name="password" class="form-control"
                                                placeholder="Ingresa tu nueva contraseña" aria-label="Password"
                                        ...
                                        <div class="mb-3">
                                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-control"
                                                placeholder="Confirma tu nueva contraseña" aria-label="Password Confirmation"
                                                aria-describedby="password-confirmation-addon" required>
                                        </div>
                                        
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-dark w-100 mt-4 mb-3">Restablecer contraseña</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
