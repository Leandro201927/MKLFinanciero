                    ...
                    <div class="card shadow-xs border">
                        <div class="card-body px-3 py-4">
                            <div class="table-responsive p-0" style="overflow: hidden">
                                <form role="form" class="text-start" action="{{ route('venta.store') }}" method="POST">
                                    @csrf

                                    <label for="Descripcion">Descripcion:</label>
                                    <div class="mb-3">
                                        <input type="text" id="Descripcion" name="Descripcion" class="form-control" placeholder="Ingresa la descripcion de la venta" aria-label="Descripcion" aria-describedby="nombre-addon">
                                    </div>
